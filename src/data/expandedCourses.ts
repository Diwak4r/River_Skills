...
export const expandedCourses: ExtendedCourse[] = [
  ...
  {
    id: 101,
    title: "Full Stack Open 2025 - Modern Web Development",
    ...
    description: "Learn React, Redux, Node.js, MongoDB, GraphQL and TypeScript in one comprehensive course. Build modern full-stack applications.",
    skills: ["React", "Node.js", "MongoDB", "GraphQL", "TypeScript", "Redux"],
    language: "English",
  ...
  {
    id: 102,
    title: "Responsive Web Design with Modern CSS",
    ...
    price: 0,
    image: "/api/placeholder/300/200",
    description: "Master HTML5, CSS3, Flexbox, CSS Grid, and responsive design principles to create beautiful websites.",
    skills: ["HTML5", "CSS3", "Flexbox", "CSS Grid", "Responsive Design", "Bootstrap"],
    language: "English", 
  ...
  },
  {
    ...
    price: 0,
    image: "/api/placeholder/300/200", 
    description: "Complete data science workflow using Python, pandas, scikit-learn, and TensorFlow for machine learning.",
  ...
  },
  {
    ...
    price: 0,
    image: "/api/placeholder/300/200",
    description: "Master modern JavaScript features including async/await, modules, classes, and the latest ES2024 features.",
    skills: ["JavaScript", "ES6+", "Async/Await", "Modules", "DOM Manipulation", "Web APIs"],
    language: "English",
