...
export default function Canvas() {
    ...
    // History Management
    const addToHistory = (newElements: Shape[]) => {
    ...
    // Drawing Logic
    const drawElement = (ctx: CanvasRenderingContext2D, element: Shape) => {
    ...
    useEffect(() => {
        ...
        ctx.restore();
    }, [elements, currentElement, offset, scale, showGrid, selectedId, theme]);
    ...
    }, [elements, selectedId, history, historyStep, scale]);
                ...
                {textInput && (
                    <div className="absolute" style={{ left: textInput.x, top: textInput.y }}>
                        <input
                            ...
                            className="bg-transparent border-b border-text-primary text-text-primary outline-none p-1 min-w-[100px]"
                            style={{
